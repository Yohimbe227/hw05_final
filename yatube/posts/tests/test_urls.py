...
class PostURLTests(TestCase):
    ...
    def test_redirects(self) -> None:
        redirects = (
            (
                self.urls.get("follow-index"),
                f'/auth/login/?next={self.urls.get("follow-index")}',
                self.anon,
            ),
            (
                self.urls.get("post-create"),
                f'/auth/login/?next={self.urls.get("post-create")}',
                self.anon,
            ),
            (
            ...
            (
                self.urls.get("post-edit"),
                f'/auth/login/?next={self.urls.get("post-edit")}',
                self.anon,
            ),
        )
